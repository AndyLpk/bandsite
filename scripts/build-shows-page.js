...
function createShow(showData) {
    ...
    showDate.innerText = new Date(showData[i].date).toLocaleDateString('en-GB', options).replace(',', '') ;
    ...
    showVenue.innerText = showData[i].place;
    ...
    showLocation.innerText = showData[i].location;
